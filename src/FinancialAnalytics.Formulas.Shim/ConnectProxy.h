...
#pragma once
#include "resource.h"
#include "FinancialAnalytics.Formulas.Shim.h"
...
class ATL_NO_VTABLE CConnectProxy : 
	...
	/*public IDispatchImpl<FinancialAnalytics_Formulas::IFormulaProcessor, 
        &FinancialAnalytics_Formulas::IID_IFormulaProcessor, 
        &FinancialAnalytics_Formulas::LIBID_FinancialAnalytics_Formulas, 1, 0>,*/
...
public:
    ...
    BEGIN_COM_MAP(CConnectProxy)
		...
		/*COM_INTERFACE_ENTRY(FinancialAnalytics_Formulas::IFormulaProcessor)
		COM_INTERFACE_ENTRY2(IDispatch, FinancialAnalytics_Formulas::IFormulaProcessor)*/
    END_COM_MAP()
...
public:
	...
	/*STDMETHOD(raw_FA)(VARIANT symbols, VARIANT dataItems, VARIANT options, VARIANT *resVal);

	VARIANT __stdcall FA(VARIANT symbols, VARIANT dataItems, VARIANT options);*/

private:
    IDTExtensibility2 *m_pConnect;
	FinancialAnalytics_Formulas::IFormulaProcessor *m_pFormulasProcessor;
