...
{
	internal class UpBars : ExcelEntityWrapper<IBars>, IBars
	{
		protected Microsoft.Office.Interop.Excel.UpBars _excelBars;

		public UpBars(ExcelEntityResolver entityResolver, Microsoft.Office.Interop.Excel.UpBars excelBars)
			: base(entityResolver)
		{
			if (excelBars == null)
			{
